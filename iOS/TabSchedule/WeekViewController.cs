...
namespace Monospace11
{
    ...
    public class WeekViewController : UIViewController
    {
		...
		private List<Monospace.Core.Day> _days;
        ...
        private class TableViewSource : UITableViewSource
        {
			...
			private List<Monospace.Core.Day> _dates;
            public TableViewSource(WeekViewController controller, List<Monospace.Core.Day> dates)
            {
				_dvc = controller;
				_dates = dates;
            }
