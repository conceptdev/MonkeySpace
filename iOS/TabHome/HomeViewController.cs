...
namespace Monospace11
{
	...
	public partial class HomeViewController : DialogViewController {
		const int days = MonkeySpace.Core.Constants.ConferenceInfo.NumberOfDays;
		...
		static HomeViewController ()
		{
			...
			for (int i = 0; i <= days; i++) {
				DayStarts [i] = MonkeySpace.Core.Constants.ConferenceInfo.StartDate.AddDays (i); //new DateTime (2013, 07, 22+i);
			}
		}
