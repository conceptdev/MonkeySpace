...
//		public List<MonkeySpace.Core.Session> Sessions;
...
//				Sessions = MonkeySpace.Core.ConferenceManager.Sessions.Values.Take (4).ToList ();
//			}
//			else if (!String.IsNullOrEmpty(_tag))
//			{	// filter by tag
//				var x = from s in MonkeySpace.Core.ConferenceManager.Sessions.Values.ToList () //AppDelegate.ConferenceData.Sessions
//						where s.HasTag(_tag)
//						select s;
//				Sessions = x.ToList();
//			}
//			else
//			{	// just show all
//				Sessions = MonkeySpace.Core.ConferenceManager.Sessions.Values.ToList ();// AppDelegate.ConferenceData.Sessions;
//			}
//			FavoriteCodes = AppDelegate.UserData.GetFavoriteCodes();
//
...
//            {
//				MonkeySpace.Core.Session s = _svc.Sessions[indexPath.Row];
//				if (sessVC == null)
